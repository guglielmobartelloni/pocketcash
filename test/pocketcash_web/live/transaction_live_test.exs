defmodule PocketcashWeb.TransactionLiveTest do
  use PocketcashWeb.ConnCase

  import Phoenix.LiveViewTest
  import Pocketcash.TransactionsFixtures

  @create_attrs %{amount: "120.5", date: "2023-1-27", title: "some title"}
  @update_attrs %{amount: "456.7", date: "2023-1-28", title: "some updated title"}
