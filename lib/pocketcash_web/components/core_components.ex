defmodule PocketcashWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(PocketcashWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(PocketcashWeb.Gettext, "errors", msg, opts)
    end
  end
